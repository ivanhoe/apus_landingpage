defmodule ApusLandingWeb.LandingLive do
      ...
      >
        ...
        <nav class="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-[#0A0F1C]/80 border-b border-white/5">
          <div class="px-6 lg:px-20 py-5">
            <div class="max-w-[1400px] mx-auto flex justify-between items-center">
              ...
              <div class="flex items-center gap-3 md:gap-6">
                ...
                <button
                  class="md:hidden flex flex-col justify-center items-center gap-1.5 w-8 h-8"
                  phx-click="toggle_menu"
                  aria-label="Toggle navigation menu"
                >
                  <span class={[
                    "block w-6 h-0.5 bg-white transition-all duration-300 origin-center",
                    if(@menu_open, do: "rotate-45 translate-y-2", else: "")
                  ]}>
                  </span>
                  <span class={[
                    "block w-6 h-0.5 bg-white transition-all duration-300",
                    if(@menu_open, do: "opacity-0", else: "")
                  ]}>
                  </span>
                  <span class={[
                    "block w-6 h-0.5 bg-white transition-all duration-300 origin-center",
          ...
          <div class={[
            ...
            <div class="px-6 pb-5 pt-2 flex flex-col gap-1 border-t border-white/5">
              <a
                href="#features"
                phx-click="close_menu"
                class="text-sm text-[#94A3B8] hover:text-white transition-colors py-3 border-b border-white/5"
              >
                Features
              </a>
              <a
              ...
              <a
                href="#setup"
                phx-click="close_menu"
                class="mt-2 inline-flex items-center gap-2 py-2.5 px-5 bg-[#22D3EE] text-[#0A0F1C] text-sm font-['JetBrains_Mono'] font-semibold rounded-lg hover:bg-[#22D3EE]/90 transition-colors self-start"
              >
                Get Started
              </a>
            </div>
        ...
        <section class="px-6 lg:px-20 py-24 bg-[#0F172A]">
          <div class="max-w-[1200px] mx-auto flex flex-col items-center gap-12">
            ...
            <div class="flex flex-col md:flex-row md:flex-wrap md:items-center md:justify-center gap-2 md:gap-3 w-full">
  ...
  defp loop_step(assigns) do
    ~H"""
    <div class={[
      "p-4 md:p-5 rounded-xl flex flex-row md:flex-col items-center gap-4 md:gap-3 md:text-center w-full md:w-[180px]",
      if(@active, do: "bg-[#0A0F1C] border border-[#22D3EE]/25", else: "bg-[#1E293B]")
    ]}>
      <.lucide_icon
        name={@icon}
        class={["w-6 h-6 md:w-7 md:h-7 shrink-0", if(@active, do: "text-[#22D3EE]", else: "text-[#64748B]")]}
      />
  ...
  defp loop_arrow(assigns) do
    ...
    <div class="md:hidden flex justify-start pl-4 py-0.5">
      <svg
        class="w-4 h-4 text-[#22D3EE]"
        viewBox="0 0 24 24"
        fill="none"
        stroke="currentColor"
        stroke-width="2"
    ...
    <svg
      class="w-6 h-6 text-[#22D3EE] hidden md:block shrink-0"
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
      stroke-width="2"
